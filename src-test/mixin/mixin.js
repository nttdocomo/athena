...
(function (root, factory) {
  if(typeof define === "function"){
    if(define.amd) {
      ...
      // the AMD loader.
      define(['../../src/class/class'],function(Backbone, inherits){
        return (root.Class = factory(Backbone,_,Text));
      });
    }
    if(define.cmd){
      define(function(require, exports, module){
        return (root.Class = factory(require('../../src/class/class')));
      })
    }
    ...
    module.exports = (root.Class = factory(require('../../src/class/class')));
  } else {
    root.Class = factory();
  }
}(this, function(Class) {
